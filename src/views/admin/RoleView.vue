<template>
  ...
  >
    <div class="mb-3">
      <label for="name" class="fw-bold"> Tên vai trò <span class="text-danger">*</span> </label>
...
const filteredRoles = computed(() => {
  ...
  return roles.value.filter(
    (role) =>
      role.name.includes(searchQuery.value) || role.id.toString().includes(searchQuery.value),
  )
})
