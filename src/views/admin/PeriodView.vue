<template>
  <div class="container">
    <div class="p-4">
      <h2 class="text-xl">THÔNG BÁO THU QUỸ</h2>
      <div class="mb-3">
        <InputText
...
const errors = ref({ month: '', year: '', deadline: '' })
...
const filteredPeriods = computed(() => {
  ...
  return periods.value.filter(
    (period) =>
      period.year.toString().includes(searchQuery.value) ||
      period.month.toString().includes(searchQuery.value),
  )
})
