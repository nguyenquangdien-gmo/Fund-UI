  ...
  actions: {
    ...
    async configureServiceAccount(credentialsFile: File, accountData: GoogleServiceAccountRequest) {
      try {
        ...
        console.log(
          'Configuring service account with',
    ...
    async updateServiceAccount(
      accountId: number,
      accountData: GoogleServiceAccountRequest,
    ...
    async createFolder(name: string, parentFolderId?: number | null, accountId?: number) {
      try {
        ...
        const request = {
          name: name,
          parentFolderId:
            parentFolderId !== null && parentFolderId !== undefined ? String(parentFolderId) : null,
        }
