    ...
    <div class="container">
        <div class="p-4">
            ...
            <div class="mb-3 flex justify-between">
                <InputText v-model="searchQuery" placeholder="Tìm kiếm theo tên team..."
                    class="w-full p-inputtext-sm" />
                <Button label="Tạo team" severity="success" class="btn" raised size="small" @click="openCreateDialog"
                    style="margin-left: 10px; padding-top: 5px;" />
            </div>
            <DataTable :value="filteredTeams" paginator :rows="10" :rowsPerPageOptions="[10, 20, 30]"
                ...
                <Column header="Actions" style="width: 20%;">
                    <template #body="{ data }">
                        ...
                        <Button label="Xóa" icon="pi pi-trash" severity="danger" class="ml-2" style="margin-left: 10px;"
